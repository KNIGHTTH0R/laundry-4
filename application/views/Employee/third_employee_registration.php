    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form method="post" class="form-horizontal" enctype="multipart/form-data" id="addEmployee" action="<?=site_url('Admin/add_employee')?>">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-lg-2 control-label">Profile photo <span style="color:red;">*</span></label>
                        <div class="col-sm-3">
                            <input type="file" class="form-control" name="profile_image" style="border:none;" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">ID Proof No.</label>
                        <div class="col-lg-3">
                            <input type="text" placeholder="Employee ID Proof Number" name="employee_id_proof_no" class="form-control">
                        </div>
                        <label class="col-lg-2 control-label">ID Proof photo</label>
                        <div class="col-sm-3">
                            <input type="file" class="form-control" name="employee_id_proof_image" style="border:none;">
                        </div>
                    </div>
            ...
            <tbody>
                ...
                foreach ($employees as $key) {?>
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary btn-xs" data-toggle="modal" id ="<?=$key['employee_id'].'-'.$key['employee_first_name'].'-'.$key['employee_middle_name'].'-'.$key['employee_last_name'].'-'.$key['employee_mobile_no']?>" data-target="#editEmployee"><i class="fa fa-pencil" title="Edit Employee"></i></button>
                        </td>
                    </tr>
                    <?php $j++;} ?>
                </tbody>
            ...
            <div class="modal-dialog" style="width: 50%;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" class="form-horizontal" id="update_employeeDetails" action="<?=site_url('Admin/update_employee')?>" enctype="multipart/form-data">
